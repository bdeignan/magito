...
Use the voice rules from [`shared/SYSTEM-INSTRUCTIONS.md`](../../../shared/SYSTEM-INSTRUCTIONS.md) and the terms in [`docs/agents/GLOSSARY.md`](../../../docs/agents/GLOSSARY.md). Do not rewrite a block of text; repair the conversation you are in. For a plain-language rewrite of dense text, use `/speaking-plainly` instead.
