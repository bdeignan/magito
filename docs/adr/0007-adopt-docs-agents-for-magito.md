...
detail doesn't carry, while `GLOSSARY.md` stays an empty header — the file now exists, but
0001's deferral of the vocabulary itself holds until a term is genuinely contested. The trade-off is one thin
